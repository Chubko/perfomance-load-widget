// The node program that captures local performance data and sends it via socket to the server
// Req:
// - socket.io-client
...
const options = {
    auth: {
        token: "ghfjdse7r8fehfhw87rni09okl"
    }
};
...
//Because the times property on cpus is time since boot, we will get now times, and 100ms from "now" times.
